...
#define SLOW_SPEED2 48
//#define MEDIUM_SPEED
#define FAST_SPEED 60
#define SMALL_TURN_ANGLE_UPPER_LIM 10
#define SMALL_TURN_ANGLE_UPPER_LIM2 15
#define NORMAL_LANE_SIZE_LIM 25
...
void CarControl::driverCar(DetectLane* detect){
    ...
    vecRightAngle = vecRightAngle / cv::norm(vecRightAngle);
        ...
        if (vecLeftSpeed.dot(vecRightSpeed) < 0.995 ||
            ...
            else if(SMALL_TURN_ANGLE_UPPER_LIM < abs(errorAngle(CarControl::preSteer)) < SMALL_TURN_ANGLE_UPPER_LIM2) CarControl::preSpeed = SLOW_SPEED2;
